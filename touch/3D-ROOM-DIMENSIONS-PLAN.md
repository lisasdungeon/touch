...
- One ten-foot spatial cell is one CSS 3D wireframe cube.
...
This creates 1,000 physical CSS cubes (`10³`) and 1,331 shared physical
...
- `scripts/hypergrid.js` lazily builds the actual 1,000 CSS cubes and 1,331
